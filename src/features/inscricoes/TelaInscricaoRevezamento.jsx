    ...
    <div style={s.page}>
      ...
      {inscsVisiveis.length > 0 && (
        <div style={{ marginBottom: 24 }}>
          <h2 style={{ color: t.accent, fontSize: 16, marginBottom: 10, fontFamily: t.fontTitle }}>
            Equipes Inscritas
          </h2>
      ...
      {revezForm && (
        <div style={{ background: t.bgHeaderSolid, border: `1px solid ${t.accentBorder}`, borderRadius: 12, padding: 20 }}>
          <div style={{ color: t.accent, fontWeight: 700, fontSize: 17, marginBottom: 16, fontFamily: t.fontTitle }}>
