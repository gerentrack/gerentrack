    ...
    <div style={s.formPage}><div style={s.formCard}>
      ...
      {docModo === "login" && docExistente && (
        <div style={{ background: t.accentBg, border: `2px solid ${t.accentBorder}`, borderRadius: 10, padding: 20, marginBottom: 20 }}>
          ...
          <button
            style={{ background:t.bgHeaderSolid, border:`1px solid ${t.border}`, borderRadius:8, padding:"10px 20px", cursor:"pointer", fontSize:13, fontWeight:600, fontFamily: t.fontBody, color:t.textSecondary, display:"flex", alignItems:"center", justifyContent:"center", gap:10, width:"100%" }}
