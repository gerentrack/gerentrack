...
function BlocoConsentimentoParental({ responsavel, onResponsavel, cpfResp, onCpfResp, emailResp, onEmailResp, aceite, onChange, erroResponsavel, erroCpfResp, erroEmailResp, erroAceite, modoSimplificado, nomeLogado, cpfLogado, emailLogado }) {
  const t = useTema();
  const inputStyle = { width:"100%", background:t.bgInput, border:`1px solid ${t.borderInput}`, borderRadius:8, padding:"10px 14px", color: t.textSecondary, fontSize:14, fontFamily: t.fontBody, outline:"none", marginBottom:4 };
                  ...
                  <div style={{ display: "flex", gap: 6, flexShrink: 0 }} onClick={e => e.stopPropagation()}>
                    ...
                    {(isOrg || isAdmin) && a.equipeId && (
                      <button
                        ...
                        style={{ background: `${t.gold}12`, color: t.gold, border: `1px solid ${t.gold}44`, borderRadius: 6, cursor: "pointer", fontSize: 11, padding: "4px 10px", fontFamily: t.fontBody }}
