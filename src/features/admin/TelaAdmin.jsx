    ...
    <div style={s.page}>
      ...
      {aba === "sistema" && (
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(360px,1fr))", gap:20 }}>
          ...
          {/* Backup */}
          <div style={s.card}>
            <div style={s.sectionHd}>💾 Backup e Restauração</div>
            ...
            <div style={{ background:"#0a0f0a", border:"1px solid #2a3a2a", borderRadius:8, padding:"14px", marginBottom:10 }}>
            ...
            <div style={{ background:"#0a0a1a", border:"1px solid #2a2a4a", borderRadius:8, padding:"14px" }}>
              <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:10 }}>
                <span style={{ fontSize:20 }}>📥</span>
                <div>
              ...
              <label style={{ display:"block", cursor:"pointer" }}>
                <div style={{ border:"1px solid #3a3a6a", color:"#88aaff", fontSize:12, textAlign:"center", padding:"8px 12px", borderRadius:6, cursor:"pointer" }}>
          ...
          {/* Identidade Visual */}
          <div style={s.card}>
            <div style={s.sectionHd}>🎨 Identidade Visual</div>
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10, marginBottom:12 }}>
              ...
              <div style={{ background:"#0a0b10", border:"1px solid #1a1d2a", borderRadius:8, padding:"10px" }}>
                ...
                {siteBranding.icon && (
                  <button style={{ fontSize:10, color:"#888", background:"transparent", border:"none", cursor:"pointer", marginLeft:4 }}
                    onClick={() => setSiteBranding({...siteBranding,icon:""})}>↩ Padrão</button>
                )}
              </div>
              {/* Logo */}
              <div style={{ background:"#0a0b10", border:"1px solid #1a1d2a", borderRadius:8, padding:"10px" }}>
                ...
                {siteBranding.logo && (
                  <button style={{ fontSize:10, color:"#888", background:"transparent", border:"none", cursor:"pointer", marginLeft:4 }}
                    onClick={() => setSiteBranding({...siteBranding,logo:""})}>↩ Padrão</button>
                )}
              </div>
            </div>
          ...
          {/* Zona de Perigo */}
          <div style={{ ...s.card, borderColor:"#3a1a1a", gridColumn:"1 / -1" }}>
            <div style={{ fontFamily:"'Barlow Condensed',sans-serif", fontSize:20, fontWeight:800, color:"#ff6b6b", marginBottom:10, letterSpacing:1 }}>
              ⚠️ Zona de Perigo
            </div>
            <p style={{ color:"#666", fontSize:12, marginBottom:14, lineHeight:1.6 }}>
