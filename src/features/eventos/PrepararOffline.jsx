...
function getStyles(t) {
  return {
    ...
    title: { fontFamily: t.fontTitle, fontSize: 30, fontWeight: 800, color: t.textPrimary, marginBottom: 8, letterSpacing: 1 },
    ...
    cardTitle: { fontFamily: t.fontTitle, fontSize: 18, fontWeight: 700, color: t.textPrimary, marginBottom: 16 },
    ...
    checkValue: { fontSize: 13, color: t.textMuted, fontFamily: t.fontTitle, fontWeight: 600 },
    btnSync: { background: `linear-gradient(135deg, ${t.accent}, ${t.accentDark})`, color: "#fff", border: "none", padding: "14px 32px", borderRadius: 8, cursor: "pointer", fontSize: 15, fontWeight: 700, fontFamily: t.fontTitle, letterSpacing: 1, marginTop: 24, display: "block", width: "100%" },
    btnVoltar: { background: "transparent", color: t.accent, border: `2px solid ${t.accent}`, padding: "11px 24px", borderRadius: 8, cursor: "pointer", fontSize: 14, fontWeight: 700, fontFamily: t.fontTitle, letterSpacing: 1, marginTop: 12, display: "block", width: "100%", textAlign: "center" },
