...
const styles = {
  ...
  tabsBar: { display: "flex", gap: 0, background: "#0D0E12", border: "1px solid #1E2130", borderRadius: 10, overflow: "hidden", marginBottom: 20, width: "fit-content" },
  tabBtn: (ativo) => ({
    background: ativo ? "#141720" : "transparent",
    borderTop: "none",
    borderBottom: "none",
    borderLeft: "none",
